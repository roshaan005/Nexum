...
function Header() {
  return (
   ...
   <div className="md:w-44 mt-5 mr-3 md:mr-5 md:mt-10 blue-grad md:h-12  h-10 w-36 rounded-2xl text-white font-semibold pl-2 pr-2 text-sm flex justify-center items-center"><a href='https://discord.gg/WV6WUnFy'>join the discord </a></div>
